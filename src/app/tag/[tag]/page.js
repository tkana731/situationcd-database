...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `${tagName}タグのシチュエーションCD作品一覧。女性向けの${tagName}系作品を探すならシチュエーションCDデータベース。`,
    keywords: `${tagName},シチュエーションCD,タグ,作品一覧,女性向け`,
    alternates: {
      canonical: canonicalUrl,
    },
    openGraph: {
      title: `${tagName}のシチュエーションCD一覧`,
      description: `${tagName}タグのシチュエーションCD作品を検索できます。`,
      url: canonicalUrl,
